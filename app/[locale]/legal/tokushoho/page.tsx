...
const GROUPS: { id: string; heading: string; items: { label: string; value: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "停止・解約の方法",
        value: `マイページ（アカウント）から、いつでもお客様ご自身で停止・解約の手続きができます。お電話やご来店は不要で、手数料はいただきません。次回お届け分を止める場合は、${SUB_CANCEL_CUTOFF}までに手続きをお願いします。この期限を過ぎたお手続きは、その次の回から反映されます。マイページの操作でお困りのときは、LINE公式アカウントのお問い合わせ窓口、またはメールでもご相談を承ります。`,
      },
      {
        label: "中途解約したときの取扱い",
        value:
      ...
      {
        label: "お申し込み内容の変更",
        value: `マイページ（アカウント）でお手続きいただけるのは、${SUB_EDITABLE_FIELDS}です。お届け先やお支払い方法の変更など、マイページに手続き画面がない項目は、お問い合わせ窓口へご連絡ください。`,
      },
    ],
  },
];
