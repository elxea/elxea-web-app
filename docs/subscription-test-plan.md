...
> **位置づけ (2026-08-10)**: 本ファイルは**現行の手順書**であり歴史的記録ではない。ただし
> **テスト方針・優先順位 (P0/P1/P2)・「やらないこと」の正本は Notion の
> [elxea Web アプリ品質保証プラン](https://www.notion.so/3b770c9d064c81a8af6dc76490d8675e)**。
> 本ファイルは同プラン P1-5「テスト顧客 + テスト注文4パターン」等を実行するための
> 定期便レーンの具体手順を持つ。方針が食い違ったら Notion 側を採る。
