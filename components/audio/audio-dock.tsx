 ...
 * - バー   `--z-sticky` (1020) … ChatBar の素の `z-40` より上
 * - 展開   `--z-modal`  (1050) … ChatBar の全画面 `z-50` より上
 *
 * ChatBar 側は Tailwind の生スケール (40/50) を使っているため数値は桁違いだが、
 * 同じ stacking context 上では 1020 > 50 で意図どおり音声側が前に出る。
 * ChatBar の z は触らない (触ると ChatBar 内部の重ね合わせが崩れるため)。
 */
