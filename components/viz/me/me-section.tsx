...
export function MeSection({
  ...
  return (
    // dev-only の /dev/me 実験ページ専用のセクション器。承認済みの縦リズム
    // (py-16 sm:py-24) は section-wide の固定 py-16 と異なり、寄せると見た目が
    // 変わる。製品ページに出す段で共有側へ寄せる。
    // DS-exception: dev-only 実験ページ / 承認済みの縦リズムを保つため
